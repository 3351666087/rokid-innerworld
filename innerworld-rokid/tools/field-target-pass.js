...
function buildMarkdown(report) {
  ...
  return [
    ...
    `- Mission ledger ready: ${report.latest_snapshot.field_acceptance.mission_ledger_ready}`,
    `- Mission trusted A1/A2/A3 prerequisite ready: ${report.latest_snapshot.field_acceptance.mission_trusted_a1_a2_a3_ready}`,
    `- Mission missing trusted anchors: ${report.latest_snapshot.field_acceptance.mission_missing_trusted_anchor_ids.join(",") || "none"}`,
    `- Trusted mission provenance ready: ${report.latest_snapshot.field_acceptance.trusted_mission_provenance_ready}`,
