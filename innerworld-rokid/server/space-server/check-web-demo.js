...
const requiredModules = [
  ...
  {
    name: "Wall Calibration / Field Kit",
    needles: [
      "Wall Calibration",
      "Field Kit",
      "calibration-section",
...
function checkStaticSources(sources) {
  ...
  const jsChecks = [
    ...
    { name: "evidence chain route", ok: sources.js.includes("/api/evidence/chain") && sources.js.includes("getEvidenceChain") },
    { name: "dynamic evidence chain rendering", ok: sources.js.includes("renderEvidenceChain") },
    { name: "evidence replay judge mode rendering", ok: sources.js.includes("evidence_replay_judge_mode") && sources.js.includes("replay_steps") && sources.js.includes("source_evidence") && sources.js.includes("A1 entry") && sources.js.includes("User B readback") },
    { name: "evidence replay privacy guard", ok: sources.js.includes("privacy") && sources.js.includes("sanitized public manifest") && !/pairing_code|access_token|serial_number|raw_chat|runtime_db_dump/i.test(sources.js.match(/function renderEvidenceChain\(\)[\s\S]*?function renderDeliveryScript\(\)/)?.[0] || "") },
    ...
    { name: "hardware-only calibration readiness", ok: sources.js.includes("hardware_calibrated_anchor_count") && sources.js.includes("hardware_calibrated_anchor_ids") && sources.js.includes("QR/image tracking/SLAM only") },
